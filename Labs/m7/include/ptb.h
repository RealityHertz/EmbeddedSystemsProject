...
//#ifdef __NUCLEO_BOARD
    ...
    //Keypad Masks
    #define KEY0MASK                0b0000000000000001
    #define KEY1MASK                0b0000000000000010
    #define KEY2MASK                0b0000000000000100
    #define KEY3MASK                0b0000000000001000
    #define KEY4MASK                0b0000000000010000
    #define KEY5MASK                0b0000000000100000
    #define KEY6MASK                0b0000000001000000
    #define KEY7MASK                0b0000000010000000
    #define KEY8MASK                0b0000000100000000
    #define KEY9MASK                0b0000001000000000
    #define KEYAMASK                0b0000010000000000
    #define KEYBMASK                0b0000100000000000
    #define KEYCMASK                0b0001000000000000
    #define KEYDMASK                0b0010000000000000
    #define KEYPOUNDMASK            0b0100000000000000
    #define KEYSTARMASK             0b1000000000000000

    #define DONT_READ_PRESSED       0b0000000000000000
    #define ONLY_NUM_KEYPAD         0b0000001111111111
//#endif
